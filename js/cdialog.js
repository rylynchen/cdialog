...
*/
Drupal.theme.prototype.CToolsCdialogdModal = function () {
  var html = '';
  html += '<div id="ctools-modal" class="popups-box cdialog">';
  html += '  <div class="ctools-modal-content cdialog-content">';
